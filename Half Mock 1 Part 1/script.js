...
using a row of cameras. The video camera had been born.` },
    ...
    'part1_21': {
        stem: `<b>Selection 3</b><br><br>When another old cave is discovered in the south of France, it is not usually news. Rather, it is an ordinary event. Such discoveries are so frequent these days that hardly anybody pays heed to them. However, when the Lascaux cave complex was discovered in 1940, the world was amazed. Painted directly on its walls were hundreds of scenes showing how people lived thousands of years ago. The scenes show people hunting animals, such as bison or wild cats. Other images depict birds and, most noticeably, horses, which appear in more than 300 wall images, by far outnumbering all other animals. Early artists drawing these animals accomplished a monumental and difficult task. They did not limit themselves to the easily accessible walls but carried their painting materials to spaces that required climbing steep walls or crawling into narrow passages in the Lascaux complex. Unfortunately, the paintings have been exposed to the destructive action of water and temperature changes, which easily wear the images away. Because the Lascaux caves have many entrances, air movement has also damaged the images inside. Although they are not out in the open air, where natural light would have destroyed them long ago, many of the images have deteriorated and are barely recognizable. To prevent further damage, the site was closed to tourists in 1963, 23 years after it was discovered.<br><br><b>21. Why was painting inside the Lascaux complex a difficult task?</b>`,
...
5 + 3 (42 + 7) - 7 (2 + 32 x 8) 0`,
    ...
    'part1_91': {
        stem: `91. <br><img src="images/perceptual_91.jpg" style="max-width: 100%;" alt="Missing image">`,
        choices: { A: `A`, B: `B`, C: `C`, D: `D`, E: `E` },
        correct: 'C'
    },
    'part1_92': {
        stem: `92. <br><img src="images/perceptual_92.jpg" style="max-width: 100%;" alt="Missing image">`,
        choices: { A: `A`, B: `B`, C: `C`, D: `D`, E: `E` },
        correct: 'C'
    },
    'part1_93': {
        stem: `93. <br><img src="images/perceptual_93.jpg" style="max-width: 100%;" alt="Missing image">`,
        choices: { A: `A`, B: `B`, C: `C`, D: `D`, E: `E` },
        correct: 'C'
    },
    'part1_94': {
        stem: `94. <br><img src="images/perceptual_94.jpg" style="max-width: 100%;" alt="Missing image">`,
        choices: { A: `A`, B: `B`, C: `C`, D: `D`, E: `E` },
        correct: 'C'
    },
    'part1_95': {
        stem: `95. <br><img src="images/perceptual_95.jpg" style="max-width: 100%;" alt="Missing image">`,
        choices: { A: `A`, B: `B`, C: `C`, D: `D`, E: `E` },
        correct: 'C'
    },
    'part1_96': {
        stem: `96. <br><img src="images/perceptual_96.jpg" style="max-width: 100%;" alt="Missing image">`,
        choices: { A: `A`, B: `B`, C: `C`, D: `D`, E: `E` },
        correct: 'C'
    },
    'part1_97': {
        stem: `97. <br><img src="images/perceptual_97.jpg" style="max-width: 100%;" alt="Missing image">`,
        choices: { A: `A`, B: `B`, C: `C`, D: `D`, E: `E` },
        correct: 'C'
    },
    'part1_98': {
        stem: `98. <br><img src="images/perceptual_98.jpg" style="max-width: 100%;" alt="Missing image">`,
        choices: { A: `A`, B: `B`, C: `C`, D: `D`, E: `E` },
        correct: 'C'
    },
    'part1_99': {
        stem: `99. <br><img src="images/perceptual_99.jpg" style="max-width: 100%;" alt="Missing image">`,
        choices: { A: `A`, B: `B`, C: `C`, D: `D`, E: `E` },
        correct: 'C'
    },
    'part1_100': {
        stem: `100. <br><img src="images/perceptual_100.jpg" style="max-width: 100%;" alt="Missing image">`,
        choices: { A: `A`, B: `B`, C: `C`, D: `D`, E: `E` },
        correct: 'C'
    },
    'part1_101': {
        stem: `101. <br><img src="images/perceptual_101.jpg" style="max-width: 100%;" alt="Missing image">`,
        choices: { A: `A`, B: `B`, C: `C`, D: `D`, E: `E` },
        correct: 'C'
    },
    'part1_102': {
        stem: `102. <br><img src="images/perceptual_102.jpg" style="max-width: 100%;" alt="Missing image">`,
        choices: { A: `A`, B: `B`, C: `C`, D: `D`, E: `E` },
        correct: 'C'
    },
    'part1_103': {
        stem: `103. <br><img src="images/perceptual_103.jpg" style="max-width: 100%;" alt="Missing image">`,
        choices: { A: `A`, B: `B`, C: `C`, D: `D`, E: `E` },
        correct: 'C'
    },
    'part1_104': {
        stem: `104. <br><img src="images/perceptual_104.jpg" style="max-width: 100%;" alt="Missing image">`,
        choices: { A: `A`, B: `B`, C: `C`, D: `D`, E: `E` },
        correct: 'C'
    },
    'part1_105': {
        stem: `105. <br><img src="images/perceptual_105.jpg" style="max-width: 100%;" alt="Missing image">`,
        choices: { A: `A`, B: `B`, C: `C`, D: `D`, E: `E` },
        correct: 'C'
    },
    'part1_106': {
        stem: `106. <br><img src="images/perceptual_106.jpg" style="max-width: 100%;" alt="Missing image">`,
        choices: { A: `A`, B: `B`, C: `C`, D: `D`, E: `E` },
        correct: 'C'
    },
    'part1_107': {
        stem: `107. <br><img src="images/perceptual_107.jpg" style="max-width: 100%;" alt="Missing image">`,
        choices: { A: `A`, B: `B`, C: `C`, D: `D`, E: `E` },
        correct: 'C'
    },
    'part1_108': {
        stem: `108. <br><img src="images/perceptual_108.jpg" style="max-width: 100%;" alt="Missing image">`,
        choices: { A: `A`, B: `B`, C: `C`, D: `D`, E: `E` },
        correct: 'C'
    },
    'part1_109': {
        stem: `109. <br><img src="images/perceptual_109.jpg" style="max-width: 100%;" alt="Missing image">`,
        choices: { A: `A`, B: `B`, C: `C`, D: `D`, E: `E` },
        correct: 'C'
    },
    'part1_110': {
        stem: `110. <br><img src="images/perceptual_110.jpg" style="max-width: 100%;" alt="Missing image">`,
        choices: { A: `A`, B: `B`, C: `C`, D: `D`, E: `E` },
        correct: 'C'
    },
    'part1_111': {
